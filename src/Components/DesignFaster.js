...
const Designfaster = () => {
  ...
  return (
    <div className="designfaster" style={{gap:"20px",fontFamily:"poppins"}}>
  
      <h1 style={{left:"-10px"}}>Design Faster</h1>
        ...
        <div className="circles item-center">
          <div className="innercircle item-center">
            <div className="innermostcircle item-center">
              ...
              <RiCopperDiamondLine size="120" color="#383874" />
            </div>
          </div>
        </div>
        <p>Total earning</p>
      ...
      <div className="bg-blue" style={{ color: "white" }}>
        <div>
          <p style={{ fontSize: "20px" }}>Total earning</p>
      ...
      <div className="types acc-data">
        ...
        <div>
Presentation<span>753</span>2304🡹
        </div>
        <div>
          Research <span>553</span>2140 🡹  </div>
      </div>
    </div>
  );
}
